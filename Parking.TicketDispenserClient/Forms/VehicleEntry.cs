    ...
    public partial class VehicleEntry : Form
    {
        ...
        private void OkButtonClick(object sender, EventArgs e)
        {
            try
            {
                ...
                parkingDatabaseFactory.SaveVehicleEntry(settings.DeviceId, ticket);
                Task.Factory.StartNew(() => OfflineRecordProcessor.Dequeue(Common.Enums.Application.TicketDispenserClient));
            }
            catch (Exception exception)
            {
                Task.Factory.StartNew(() => OfflineRecordProcessor.Queue(ticket, Common.Enums.Application.TicketDispenserClient));
        ...
        private void PrintTicket()
        {
            try
            {
                ...
                string directory = Path.Combine(Path.GetDirectoryName(System.Windows.Forms.Application.ExecutablePath), @"Tickets\");
